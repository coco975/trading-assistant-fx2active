...
class BearishFibLevels:
    ...
    @property
    def risk(self) -> float:
        return self.stop_loss - self.entry_78_6

    @property
    def reward(self) -> float:
        return self.entry_78_6 - self.take_profit
...
def bullish_fib_levels(
    *,
    ...
    """Bullish Fib: 100% at swing low, 0% at swing high."""
    _validate(
        swing_low=swing_low,
...
def bearish_fib_levels(
    *,
    ...
    """Bearish Fib: 100% at swing high, 0% at swing low."""
    _validate(
        swing_low=swing_low,
        swing_high=swing_high,
        pip_size=pip_size,
    ...
    price_range = swing_high - swing_low
    entry = swing_low + retracement * price_range
    stop = swing_high + stop_buffer_pips * pip_size
    return BearishFibLevels(
        swing_high=swing_high,
        swing_low=swing_low,
        entry_78_6=entry,
        stop_loss=stop,
